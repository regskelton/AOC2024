...
var controller = (function (m, v) {
        ...
        function addRoutes(routes, grid, from, to) {
        ...
        return {
            init: function () {
                ...
                for (let rf = 0; rf < keypad.length; rf++) {
                    for (let cf = 0; cf < keypad[rf].length; cf++) {

                        for (let rt = 0; rt < keypad.length; rt++) {
                            for (let ct = 0; ct < keypad[rf].length; tf++) {

                                addRoutes(routes, keypad, rf, cf, rt, ct);
                            }
                        }
                    }
                }
